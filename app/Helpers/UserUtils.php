...
class UserUtils
{
     ...
     * @param {number} $userId
     * @return {object} user settings { date_format, date_format_php, currency }
     */
    public static function getUserSetting($userId)
    {
        ...
        $userInfoData = \App\Models\UserInfo::where('user_id', $userId)->select(['currency', 'date_format', 'date_format_separator'])->first();
