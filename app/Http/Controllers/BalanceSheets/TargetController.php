...
{
    protected $viewPath = 'balancesheet.targets';
    protected $routePath = 'balancesheet/targets';
    protected $translationPrefix = 'balancesheet.target.';
    ...
    {
        $page = (object) ['title' => __($this->translationPrefix . 'Targets'), 'route' => '', 'routeCreate' => route($this->routePath . '/create'),
    ...
    public function create()
    {
        ...
        $page = (object) ['title' => __($this->translationPrefix . 'Targets'), 'name' => __($this->translationPrefix . 'CreateNew'),
            'route' => route($this->routePath . '/create'), 'routeSave' => route($this->routePath . '/store'), 'routePath' => $this->routePath];
        $breadcrumbPath = $this->routePath;
    ...
    public function edit($id)
    {
        ...
        $page = (object) ['title' => __($this->translationPrefix . 'Targets'), 'name' => __('tables.Edit') . ': ' . $data->name,
            'route' => route($this->routePath . '/edit', ['id' => $id]),
            'routeSave' => route($this->routePath . '/update', ['id' => $id]), 'routePath' => $this->routePath];
        $breadcrumbPath = $this->routePath;
    ...
    {
        $fieldList = ['id', 'name'];
        $columnList = [__('tables.Id'), __('tables.Name')];
    ...
    {
        $uniqueName = 'unique:targets,name';
        if ($id) {
            $uniqueName .= ',' . $id;
        }
