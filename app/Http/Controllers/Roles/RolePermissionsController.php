...
class RolePermissionsController extends Controller
{
    ...
    public function index($roleId = null)
    {
        ...
        $page = (object) ['title' => __($this->translationPrefix . 'RolePermisisons'),
            'name' => __($this->translationPrefix . 'EditRolePermissions') . ': ' . $role->name,
            'route' => '',
            'routeSave' => route($this->routePath . '/update', ['id' => $roleId]),
            'routePath' => $this->routePath, 'translationPrefix' => $this->translationPrefix, 'viewPath' => $this->viewPath];
        $breadcrumbPath = $this->routePath;
        $permissionsList = $this->getRolePermissions($roleId);
        return view($this->viewPath . '.list', compact('page', 'breadcrumbPath', 'roleId', 'permissionsList'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route($this->routePath, ['roleId' => $id])->with(['success' => __('general.UpdatedSuccess')]);
    }
