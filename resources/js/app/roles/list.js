...
let KTPermissionList = (function () {
    ...
    function initializeTableActions() {
        $('.table').on('click', '.item-delete', function (ev) {
            confirmAction(ev, i18n.t('permission.ConfirmItemDelete'));
        });
    }
    ...
    function initializeTableFilters(table) {
        ...
        $('#toolbarFilter').on('click', 'button[type=submit]', function () {
            ...
            let slugVal = $('#filterSlug').val();
            table.column('slug:name').search(slugVal);
