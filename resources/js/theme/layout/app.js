...
var KTApp = function() {
    ...
    var initSelect2 = function() {
        ...
        elements.map(function (element) {
            ...
            if ( element.getAttribute('data-kt-flags') === 'true') {
                options.templateResult = function(country) {
                    if (country.element) {
                        return $('<span><img class="dropdown-flag" src="' + country.element.getAttribute('data-kt-flag') + '" />' + country.text + '</span>');
                    }
                    else {
                        return country.text;
                    }
