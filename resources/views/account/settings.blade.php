...
<div class="content d-flex flex-column flex-column-fluid">
    ...
    <div class="post d-flex flex-column-fluid">
        <!--begin::Container-->
        <div class="container">
            @include($page->viewPath.'.user_preview', ['selectedMenu' => 'settings'])
            <!--begin::Basic info-->
                                    ...
                                    <div class="col-lg-4">
                                        <div class="fv-row mb-0">
                                            <label for="current_password"
                                                class="form-label fs-6 fw-bolder mb-3">{{ __($page->translationPrefix.'CurrentPassword') }}</label>
                                            <input type="password"
                                                class="form-control form-control-lg form-control-solid"
            ...
            <div class="card mb-5 mb-xl-10">
                ...
                <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse"
                    ...
                    <div class="card-title m-0">
                        <h3 class="fw-bolder m-0">{{ __($page->translationPrefix.'ConnectedAccounts') }}</h3>
                    </div>
                </div>
                <!--end::Card header-->
                <!--begin::Content-->
                            ...
                            <div class="py-2">
                                ...
                                <div class="d-flex flex-stack">
                                    <div class="d-flex">
                                        ...
                                        <div class="d-flex flex-column">
                                            <a href="#"
                                                class="fs-5 text-dark text-hover-primary fw-bolder">{{ __($page->translationPrefix.'Google') }}</a>
                                            <div class="fs-6 fw-bold text-gray-400">{{ __($page->translationPrefix.'GoogleRemoveInfo') }}
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="d-flex flex-stack">
                                    <div class="d-flex">
                                        ...
                                        <div class="d-flex flex-column">
                                            <a href="#"
                                                class="fs-5 text-dark text-hover-primary fw-bolder">{{ __($page->translationPrefix.'Facebook') }}</a>
                                            <div class="fs-6 fw-bold text-gray-400">
                                                {{ __($page->translationPrefix.'FacebookRemoveInfo') }}
                                            </div>
                                        </div>
                                    </div>
                                    <div class="d-flex justify-content-end">
                                ...
                                <div class="d-flex flex-stack">
                                    <div class="d-flex">
                                        <div class="d-flex flex-column">
                                            <span
                                                class="fs-5 text-dark text-hover-primary fw-bolder">{{ __($page->translationPrefix.'NoAccountConnected') }}</span>
                                            <div class="fs-6 fw-bold text-gray-400">
                                                {{ __($page->translationPrefix.'ConnectAccountsInfo') }}
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="card">
                ...
                <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse"
                    ...
                    <div class="card-title m-0">
                        <h3 class="fw-bolder m-0">{{ __($page->translationPrefix.'DeleteAccount') }}</h3>
                    </div>
                </div>
                <!--end::Card header-->
                <!--begin::Content-->
                    ...
                    <form id="account_delete_form" class="form" method="post"
                        ...
                        <div class="card-body border-top p-9">
                            ...
                            <div
                                ...
                                <div class="d-flex flex-stack flex-grow-1">
                                    <!--begin::Content-->
                                    <div class="fw-bold">
                                        <h4 class="text-gray-900 fw-bolder">{{ __($page->translationPrefix.'DeleteAccountInfoTitle') }}
                                        </h4>
                                        <div class="fs-6 text-gray-700">
                                            {{ __($page->translationPrefix.'DeleteAccountInfoDescription') }}
                                            <br />
                                        </div>
                                    </div>
                                    <!--end::Content-->
                            ...
                            <div class="form-check form-check-solid fv-row">
                                ...
                                <label class="form-check-label fw-bold ps-2 fs-6"
                                    for="confirm_delete">{{ __($page->translationPrefix.'ConfirmAccountDelete') }}</label>
                            </div>
                            <!--end::Form input row-->
                        </div>
                        <!--end::Card body-->
                        ...
                        <div class="card-footer d-flex justify-content-end py-6 px-9">
                            <button id="account_delete_submit" type="submit"
                                class="btn btn-danger fw-bold">{{ __($page->translationPrefix.'DeleteAccount') }}</button>
                        </div>
                        <!--end::Card footer-->
                    </form>
                    <!--end::Form-->
