                ...
                <div class="collapse show">
                    ...
                    <form id="edit_form" class="form" method="post" action="{{ $page->routeSave }}"
                        ...
                        <div class="card-body border-top p-9">
                            ...
                            <div class="row mb-6">
                                <!--begin::Label-->
                                <label class="col-lg-3 col-form-label required fw-bold fs-6">{{ __('tables.Year') }}</label>
                                <!--end::Label-->
                                <!--begin::Col-->
                                <div class="col-lg-9">
                                    <select name="year" aria-label="{{ __($page->translationPrefix.'SelectYear') }}" data-control="select2"
                                        data-placeholder="{{ __($page->translationPrefix.'SelectYear') }}"
                                        data-hide-search="true"
                                        class="form-select form-select-solid form-select-lg">
                                        <option value="">{{ __($page->translationPrefix.'SelectYear') }}</option>
                                        {!! $yearSelectOptions !!}
                                    </select>
                                </div>
                                <!--end::Col-->
                            ...
                            <div class="row mb-6">
                                <!--begin::Label-->
                                <label class="col-lg-3 col-form-label required fw-bold fs-6">{{ __('tables.Month') }}</label>
                                <!--end::Label-->
                                <!--begin::Col-->
                                <div class="col-lg-9">
                                    <select name="month" aria-label="{{ __($page->translationPrefix.'SelectMonth') }}" data-control="select2"
                                        data-placeholder="{{ __($page->translationPrefix.'SelectMonth') }}"
                                        class="form-select form-select-solid form-select-lg">
                                        <option value="">{{ __($page->translationPrefix.'SelectMonth') }}</option>
                                        {!! $monthSelectOptions !!}
                                    </select>
                                </div>
                                <!--end::Col-->
